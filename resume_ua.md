...
<h2 style="border:none; margin-bottom:0;">
	🚀 <a href="https://in-spectrum.github.io/Portfolio/index_ua.html" target="_blank">Портфоліо</a>
</h2>

---

<br>
<h2 style="margin-top:0;">🧩 БАЖАНА ПОСАДА</h2>

Middle Software Developer, С++, Qt (QML), GStreamer, Video systems, Android (Java), Embedded systems.

<h2 style="margin-top:0;">👨‍💻 ПРО СЕБЕ</h2>
...
<br>
<h2 style="margin-top:0;">💼 ДОСВІД РОБОТИ</h2>
...
[https://archer.ua/ua](https://archer.ua/ua)

*жовтень 2019 р. - лютий 2022 р.*

- розробив [додаток](https://in-spectrum.github.io/Portfolio/index_ua.html#app_1) (адаптований для: кастомного пульта, ПК, сенсорного планшета) для управління тепловізійною оптико-електронною системою відеоспостереження, для платформ: Windows, Ubuntu, **ARM** (NVIDIA Jetson TX2), з використанням: С++, Multithreading, Qt, **QML**, вбудовані карти **OSM**, **GStreamer**, Serial-port, **Pelco-D**;

- розробив [додаток](https://in-spectrum.github.io/Portfolio/index_ua.html#app_2) **«Балістичний калькулятор»** для управління та перегляду (запису) відео з оптичного прицілу, для платформи Android, з використанням: **Java**, **GStreamer**, [HERE Map SDK](https://www.here.com);

- розробив [додаток](https://in-spectrum.github.io/Portfolio/index_ua.html#app_3) (меню управління, OSD) для вбудованої системи оптичного розвідувального приладу, для платформи **HiSilicon “HIVIEW-TECH”**, з використанням: **С**, **Multithreading**, [LVGL](https://lvgl.io), **I2C**;

- оптимізував код попередніх розробників, для роботи з відео-потоком без використання додаткових бібліотек **OpenCV** — лише [GStreamer](https://gstreamer.freedesktop.org);
...
- робота в команді, участь у проєктуванні приладів, розробка клієнтської частини програмного забезпечення, випробування та презентація приладів замовникам, відрядження за кордон;
...
- розробив [додаток](https://in-spectrum.github.io/Portfolio/index_ua.html#app_7) **«IP-cam GO»** (клієнтська частина мультимедійної системи) для реєстрації/перегляду відео з IP-камер, для платформи Android, з використанням: **Java**, **Multithreading**, **REST API**;
...
<br>
<h2 style="margin-top:0;">⚙️ ОСОБИСТІ ПРОЄКТИ</h2>

*2012 р. – 2025 р.*

- розробив кросплатформену систему [**"BypassNAT"**](https://github.com/In-spectrum/BypassNAT) (клієнт/сервер) для віддаленого управління комп'ютером та приладами, для платформ: Windows, Ubuntu, **ARM** (Raspberry Pi), Android, з використанням: C++, Multithreading, Qt, QML, TCP/IP, **GStreamer**, [**MediaMTX**](https://github.com/bluenviron/mediamtx);
...
- розробив кросплатформений ігровий додаток [**"Mean Mole"**](https://in-spectrum.github.io/Portfolio/index_ua.html#app_6), для платформ: Windows, Ubuntu, Android, iOS, Windows Phone, з використанням: C++, Qt, QML, Multithreading;
...
<br>
<h2 style="margin-top:0;">🛠 ТЕХНОЛОГІЇ ТА НАВИЧКИ</h2>

- **Windows, Ubuntu, Android, Mac, iOS, Arduino**;
- вбудовані системи на базі Linux (**NVIDIA Jetson TX2**, **Raspberry Pi**, **HiSilicon HIVIEW-TECH**);
- **С, С++, Java**;
- **ООП, STL, TCP, FTP, HTTP/REST, Multithreading**;
- **MySQL, SQLite**;
- **GStreamer** (*RTP, RTSP, RTMP, HTTP, HLS; h.264, h.265, VP8, AV1*);
- **Serial-port** (*COM-port, RS-232, RS-485*), **BluetoothLE**, **I2C**;
- **Qt, QML, LVGL**;
- робота з картами, геолокація, **Map-OSM**;
- комунікація з ОС по **ssh-протоколу**;
- управління поворотними системами (*натівними та Pelco-D протоколами*);
- бібліотека комп’ютерного зору **NVIDIA TensorFlow**;
- **COM-об’єкти, JSON, Git, Trello, Figma, HTML**;
- **MediaMTX, Nginx, DirectShow, libVLC, OpenCV**;
- притримуюсь шаблону написання додатків **MVP (Model-View-Presenter)**;
- публікація додатків в **Google Play**;
- англійська — читання документації;
- охоче розбираюсь у чужому коді;

<br>
<h2 style="margin-top:0;">⚽ ДОДАТКОВА ІНФОРМАЦІЯ</h2>
