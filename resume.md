...
### Thermal Vision Technologies “Archer”, Kyiv
...
<br>
<h2 style="margin-top:0;">Freelancer</h2>
...
- **C, C++, Java**;
- **OOP, STL, TCP, FTP, HTTP/REST, Multithreading**;
- **MySQL, SQLite**;
...
- following **MVP (Model-View-Presenter)** application architecture pattern;
